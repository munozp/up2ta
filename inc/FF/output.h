...
void print_op_name( int index );
				...
				/*
				 * Se annaden estas tres funciones para recoger la heuristica (getHeuristica) y el
				 * coste (getCoste) que proporciona el proceso hijo. Finalmente se annade una variacion
				 * de la funcion print_op_name llamada print_op_name_only_info que solamente muestra la
				 * informacion por la salida estandar. Es ideal para trazar el comportamiento del programa
				 * en caso de errores.
				 */
