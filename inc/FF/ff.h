...
/*
 * Archivo de cabecera creado para el desarrollo del presente proyecto.
 */
...
typedef struct _BfsNode {
  ...
  /* Se annaden los atributos h_double y coste para guardar la heuristica y coste
   * proporcionados por el proceso hijo, respectivamente.
   */
